...
conn.execute('''CREATE TABLE IF NOT EXISTS ACCOUNT(ID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,ACCOUNT_NUMBER CHAR(10) NOT NULL,CUSTOMER_ID INTEGER NOT NULL,CURRENT_BALANCE DECIMAL(8, 2) NOT NULL,FOREIGN KEY (CUSTOMER_ID)REFERENCES CUSTOMER (CUSTOMER_ID));''')
